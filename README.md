...
### 🚀 Aspiring Fullstack Developer | Turning Ideas into Functional Web Experiences
...
🎓 Mahasiswa Informatika yang sedang mendalami dunia pengembangan perangkat lunak.

💻 Fokus saat ini: Membangun aplikasi web yang *seamless* dari *front-end* hingga *back-end*.
...
*   Building robust **three-tier architectures**.

*   Mastering **API integrations** & distributed systems.

*   Crafting clean, responsive, and aesthetic user interfaces.
